...
if (isset($input['idusuario'], $input['nombre'], $input['idtipo_usuario'])) {
    $json = $api->updateUsuario($input['idusuario'], $input['nombre'], $apellido, $email, $contrasena, $input['idtipo_usuario'], $empresa, $cargo, $acceso_plataforma, $imagen);
} else {
