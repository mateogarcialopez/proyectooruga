...
if (isset($input['idproyecto'], $input['nombre_proyecto'],$input['idcliente'])) {
    $json = $api->updateProyecto($input['idproyecto'], $input['nombre_proyecto'], $input['idcliente'], $anio, $descripcion_proyecto, $objetivo_general);
} else {
