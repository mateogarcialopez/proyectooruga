...
if (isset($input['estado_solicitud'])) {
...
if (isset($input['idsolicitud'], $input['identregable'], $input['idresponsable'])) {
    $json = $api->updateSolicitud($input['idsolicitud'], $input['identregable'], $input['idresponsable'], $descripcion_solicitud, $fecha_recepcion, $prioridad, $duracion_dias, $usuario_genera_solicitud, $nombre, $proceso_asociado, $estado_solicitud);
} else {
